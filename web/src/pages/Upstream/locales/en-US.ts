...
export default {
  ...
  'page.upstream.step.input.healthyCheck.active.http_path': 'The HTTP request path to use when performing active health checks (default is /)',
  ...
  'page.upstream.checks.active.unhealthy.http_failures.description': 'The number of HTTP failures for active health checks, the default value is 0. If this value is reached, it means that the upstream service target node is unhealthy.',
  'page.upstream.checks.passive.healthy.http_statuses.description': 'When the probe return value of a passive health check is one of the values in the HTTP status code list, it means that the health status is generated by the proxy traffic.',
  'page.upstream.checks.passive.healthy.successes.description': 'The number of successes of normal proxy traffic observed through passive health checks. If this value is reached, the upstream service target node is considered healthy.',
  'page.upstream.checks.passive.unhealthy.http_statuses.description': 'When the probe return value of a passive health check is one of the values in the HTTP status code list, it means that the unhealthy state is generated by proxy traffic.',
  'page.upstream.checks.passive.unhealthy.http_failures.description': 'The number of HTTP failures in proxy traffic as observed by passive health checks. If this value is reached, the upstream service target node is considered unhealthy.',
  'page.upstream.checks.passive.unhealthy.tcp_failures.description': 'The number of TCP failures in the proxy traffic observed by the passive health check. If this value is reached, the upstream service target node is considered unhealthy.'
};
