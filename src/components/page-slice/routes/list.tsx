...
import { type UseListReturn } from '@/apis/hooks';
...
type RouteListProps = {
  ...
  req: UseListReturn<ListPageKeys, PageSearchType, APISIXType['Route']>;
};

export const RouteList = (props: RouteListProps) => {
  const { detailTo, addTo, req } = props;
  const { data, isLoading, refetch, pagination } = req;
