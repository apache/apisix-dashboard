...
//}
//
//var _ = ginkgo.Describe("Route_Online_Debug_Basic_Route", func() {
//	table.DescribeTable("Route_Online_Debug_Basic_Route", func(tc func() base.HttpTestCase) {
//		base.RunTestCase(tc())
//	},
//		table.Entry("create route", func() base.HttpTestCase {
//			createRouteBody := map[string]interface{}{
//				"id":      1,
//				"name":    "test_route",
//				"uri":     "/test",
//				"status": 1,
...
//			}
//		}),
//		table.Entry("hit route for test", func() base.HttpTestCase {
//			return base.HttpTestCase{
//				Object:       base.APISIXExpect(),
...
//			}
//		}),
//		table.Entry("hit route by route debugger", func() base.HttpTestCase {
//			return base.HttpTestCase{
//				Object: base.APISIXExpect(),
//				Method: http.MethodPost,
...
//					"online_debug_route_id":         "1",
//					"online_debug_path":             "/test",
