...
export default {
  ...
  'route.publish.env': '发布环境',
  'route.publish.env.head': '发布路由',
  'route.publish.env.comment': '请填写变更备注',
  'route.publish.env.testing': '测试',
  'route.publish.env.pre': '预发布',
  'route.publish.env.release': '线上',
  'route.publish.ok': '发布',
  'route.publish.env.click': '请选择发布环境',
  'route.publish.env.input.desc': '变更备注长度在0-200字符',
};
