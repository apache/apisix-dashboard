...
context('Create and Batch Deletion Routes', () => {
  ...
  it('should delete the route', function () {
    ...
    cy.get('.ant-table-row-level-0').contains(data.test0).find('.ant-table-cell').find('.ant-checkbox').check();
    cy.get('.ant-table-row-level-0').contains(data.test2).find('.ant-table-cell').find('.ant-checkbox').check();
