...
export default {
  ...
  'page.route.debug.path.rules.required.description':
    'Please enter a valid HTTP request path, begin with /',
  ...
  'page.route.PanelSection.title.chooseRequestAddress': 'Choose Request Address',
  'page.route.PanelSection.title.enterRequestPath': 'Enter Request Path',
