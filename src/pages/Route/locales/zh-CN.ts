export default {
  ...
  'route.request.config.path.description1':'1. 请求路径，如 /foo/index.html，支持请求路径前缀 /foo/* ；',
  ...
  'route.request.override.use.domain.name.default.analysis':'使用域名时，默认解析本地：/etc/resolv.conf',
