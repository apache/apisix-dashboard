...
export default {
  ...
  'component.plugin-flow.text.no-start-node': 'Please connect the start component',
  'component.plugin-flow.text.no-root-node': 'Root component not found',
  'component.plugin-flow.text.start-node': 'Start',
  'component.plugin-flow.text.general': 'General',
  'component.plugin-flow.text.nodes-area': 'Components',
