export default {
  ...
  'route.match.parameter.name.rule': 'Only letters, numbers, - and _ are supported, and can only begin with letters',
  ...
  'route.meta.api.name.rule':'Maximum length 100, only letters, Numbers, _, and - are supported, and can only begin with letters',
  'rotue.meta.api.rule':'Only letters, numbers, _ and - are supported, and can only begin with letters',
  ...
  'route.request.config.domain.or.ip':'Domain Name or IP, support for generic Domain Name, for example: *.test.com',
  'route.request.config.input.domain.name':'Please input Domain Name',
  'route.request.config.domain.name.rule':'Only letters, numbers and * are supported. * can only be at the beginning, and only single * is supported',
  'route.request.config.create':'Create',
  'route.request.config.path':'Path',
  'route.request.config.path.description1':'1. Request path, for example: /foo/index.html, supports request path prefix /foo/* ;',
  ...
  'route.request.override.use.domain.name.default.analysis':'When using Domain Name, it will analysis the local: /etc/resolv.conf by default',
