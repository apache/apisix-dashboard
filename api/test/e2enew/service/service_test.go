...
var _ = ginkgo.Describe("create service with plugin", func() {
	...
	ginkgo.It("get the service s1", func() {
		base.RunTestCase(base.HttpTestCase{
			...
			Headers:    map[string]string{"Authorization": base.GetToken()},
			ExpectCode: http.StatusOK,
			ExpectBody: "\"upstream\":{\"nodes\":[{\"host\":\"" + base.UpstreamIp + "\",\"port\":1980,\"weight\":1}],\"type\":\"roundrobin\"},\"plugins\":{\"limit-count\":{\"count\":100,\"key\":\"remote_addr\",\"rejected_code\":503,\"time_window\":60,\"policy\":\"local\"}}",
			Sleep:      base.SleepTime,
		})
	})
	ginkgo.It("create route using the service just created", func() {
...
var _ = ginkgo.Describe("create service with all options via POST method", func() {
	...
	ginkgo.It("get the service s2", func() {
		base.RunTestCase(base.HttpTestCase{
			...
			Headers:    map[string]string{"Authorization": base.GetToken()},
			ExpectCode: http.StatusOK,
			ExpectBody: "\"name\":\"testservice22\",\"desc\":\"testservice_desc\",\"upstream\":{\"nodes\":[{\"host\":\"" + base.UpstreamIp + "\",\"port\":1980,\"weight\":1}],\"type\":\"roundrobin\"},\"plugins\":{\"limit-count\":{\"count\":100,\"key\":\"remote_addr\",\"rejected_code\":503,\"time_window\":60,\"policy\":\"local\"}},\"labels\":{\"build\":\"16\",\"env\":\"production\",\"version\":\"v2\"},\"enable_websocket\":true}",
			Sleep:      base.SleepTime,
		})
	})
	ginkgo.It("create route using the service just created", func() {
