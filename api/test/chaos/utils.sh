...
create_configmap() {
    kubectl create configmap apisix-cm0 --from-file ./apisix_config.yaml
    ...
    # kubectl create configmap apisix-cm3 --from-file ./apisix_logs
    kubectl create configmap apisix2-cm0 --from-file ./apisix_config2.yaml
    ...
    kubectl create configmap upstream-cm0 --from-file ./upstream.conf
}
