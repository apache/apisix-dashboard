...
If the container `apisix-dashboard` is ok, access `http://127.0.0.1:8080` to use the dashboard with a front-end GUI, where the default username and password are `admin`.
