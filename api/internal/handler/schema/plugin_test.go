...
func TestPlugin(t *testing.T) {
	...
	// consumer schema
	assert.Equal(t, `{"properties":{"password":{"type":"string"},"username":{"type":"string"}},"required":["username","password"],"title":"work with consumer object","type":"object"}`, basicAuthConsumerSchema)
}
